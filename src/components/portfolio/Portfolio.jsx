    ...
    return (
        <section className="portfolio container section" id="portfolio">
            ...
            <div className="portfolio__filters">
                ...
                <span className={activeFilter === 3 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Spring Boot"); setActiveFilter(3) }}>
                    Spring Boot
                </span>
                <span className={activeFilter === 4 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("IoT"); setActiveFilter(4) }}>
				IoT
                </span>
            </div>
                        ...
                        <motion.div
                            ...
                            key={id}>
                                <div className="portfolio__thumbnail">
                                    <img src={image} alt={`${title} project thumbnail`} className="portfolio__img" height="600" />
								...
								{/* Project Duration */}
								<p className="portfolio__duration">{elem.duration}</p>
